...
QUESTIONS_URLS = ["https://www.khanacademy.org/api/internal/discussions/scratchpad/1981573965/questions?limit=10",
                  "https://www.khanacademy.org/api/internal/discussions/video/introduction-to-vectors-and-scalars/questions?limit=10"]
...
class Questions:
    ...
    def result_ids(self, _query: str) -> List[int]:
        result = self.combined_search(_query)
